...
%\usepackage[backend=biber,style=gb7714-2015,citestyle=gb7714-2015,sorting=none]{biblatex}
...
\NKTsetup{%
  论文题目(中文) = 南开大学软件学院本科生毕业论文模板 2026,
 %论文题目(中文)(第二行) =第二行中文题目，填无则不显示本行,
  论文题目(中文)(第二行) =无,
  论文题目(英文) =  {Undergraduate Thesis Template, College of Software, },
  %论文题目(英文)(第二行) =,
  论文题目(英文)(第二行) = {Nankai University 2026},
  学号           = 26xxxxx,
  姓名          = XX,
  年级          = 2026,
  级            = 级,
  ...
  指导教师       =XXX\quad （副）教授,
  % 如果有校外导师则填写校外导师。没有填无
  %校外导师     = 罗XX \quad 高工（字节跳动），填无则不显示本行,
  校外导师      =无,  
  论文完成时间   = 2026,
  年 = 年,
  月份 = 4,
